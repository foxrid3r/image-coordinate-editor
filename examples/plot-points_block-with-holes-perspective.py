"""Plot world-coordinate data on block-with-holes-perspective.png using its embedded coordinate system."""
...
DEFAULT_INPUT = HERE / "images" / "block-with-holes-perspective.png"
DEFAULT_OUTPUT = HERE / "output" / "block-with-holes-perspective-points.png"
