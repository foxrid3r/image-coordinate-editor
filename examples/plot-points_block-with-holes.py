"""Plot world-coordinate data on block-with-holes.png using its embedded coordinate system."""
...
DEFAULT_INPUT = HERE / "images" / "block-with-holes.png"
DEFAULT_OUTPUT = HERE / "output" / "block-with-holes-points.png"
